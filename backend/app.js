...
import hotelCategoryRoutes from "./routes/hotelCategoryRoutes.js";
import jeepSafariRoutes from "./routes/jeepSafariRoutes.js";
import jeepSafariCategoryRoutes from "./routes/jeepSafariCategoryRoutes.js";
import tourGuideRoutes from "./routes/tourGuideRoutes.js";
import tourGuideSpecialtyRoutes from "./routes/tourGuideSpecialtyRoutes.js";
...
app.use("/api/jeep-safaris", jeepSafariRoutes);
app.use("/api/jeep-safari-categories", jeepSafariCategoryRoutes);
app.use("/api/tour-guides", tourGuideRoutes);
app.use("/api/tour-guide-specialties", tourGuideSpecialtyRoutes);
